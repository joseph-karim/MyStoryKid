...
// For now, we'll mock the responses with a timeout
...
export const generateStoryOutline = async (storyData) => {
  try {
    ...
    // In a real app, this would call the OpenAI API with a formatted prompt
    // For now, let's simulate a delay and return a mock response
...
export const generateSpreadContent = async (storyData, outline, spreadNumber) => {
  try {
    ...
    // For demonstration purposes, generate mock content
    const pageContent = generateMockPageContent(
      spreadOutline, 
      mainCharacter.name, 
      spreadNumber, 
      textLength, 
